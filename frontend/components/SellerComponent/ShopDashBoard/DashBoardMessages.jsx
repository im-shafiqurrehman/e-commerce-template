...
//       </div>
//       <div className="pl-3">
//         <h1 className="text-lg">Half Attire</h1>
...
//           />
//           <div className="pl-3">
//             <h1 className="text-lg font-semibold">Half Attire</h1>
        ...
        >
          {item.sender !== sellerId && (
            <>
              {userData?.avatar ? (
                <img
                  src={`${backend_url}/174712722915shafiq.png`} // Ensure backend_url is defined correctly
                  className="h-8 w-8 rounded-full"
                  alt="User Avatar"
                  onError={(e) => {
